...
const CreditoPath = path.resolve(__dirname, "contracts", "Credito.sol");
const source = fs.readFileSync(CreditoPath, "utf8");
...
console.log(contratoCompilado.contracts["Credito.sol"].Credito);

// Pedimos apenas o nosso contrato para exportação
//module.exports = contratoCompilado.contracts["Credito.sol"].Credito;
module.exports = contratoCompilado.contracts["Credito.sol"].Credito;